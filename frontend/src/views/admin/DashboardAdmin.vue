<script setup>
import { ref } from 'vue';
import { XSquare, LayoutDashboard, BusFrontIcon, RouteIcon, UserCircle, LogOut, MenuIcon  } from 'lucide-vue-next';
    ...
    <div class="min-h-screen flex flex-col lg:ml-72">
        <header class="bg-white shadow-sm sticky top-0 z-10">
            <div class="px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
                <button @click="toggleSidebar" class="lg:hidden text-gray-600 hover:text-gray-900 focus:outline-none">
